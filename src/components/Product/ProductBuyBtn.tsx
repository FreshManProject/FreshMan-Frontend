...
export default function ProductBuyBtn() {
    ...
    return (
        <div
            className={
                'max-w-default fixed bottom-0 left-0 right-0 z-40 z-[21] m-auto flex items-center justify-between bg-white px-2 py-4 shadow-top [&>#likeBtn]:basis-16 [&>#primaryBtn]:flex-1'
            }
        >
